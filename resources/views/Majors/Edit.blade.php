...
<div class="mb-8 border-b border-[#E5E3DB] pb-5">
    ...
    <p class="mt-1 text-sm text-slate-500">Memperbarui catatan jurusan <span class="font-medium text-[#16213A]">{{ $major['name'] }}</span>.</p>
</div>

<form action="{{ route('Major.update', $major['id']) }}" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
    @csrf
    @method('PUT')

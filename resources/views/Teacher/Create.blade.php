...
<form action="{{ route('Teacher.store') }}" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
    @csrf
    ...
    <div>
        ...
        <input type="text" id="name" name="name" placeholder="Nama lengkap guru beserta gelar"
            class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none">
    </div>
    ...
    <div class="flex justify-end gap-4 border-t border-[#EFEDE6] pt-6">
        ...
        <button type="submit"
            class="bg-[#16213A] px-6 py-2.5 text-sm font-medium text-white transition hover:bg-[#26324f]">Simpan Data Guru</button>
    </div>
</form>
